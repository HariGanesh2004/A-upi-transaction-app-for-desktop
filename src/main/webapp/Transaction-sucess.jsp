  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      body {
        margin: 0;
        background: radial-gradient(1200px 800px at 50% -100px, rgba(22, 163, 74, 0.18), transparent 60%) , var(--bg);
      ...
      .card {
        width: 100%;
        max-width: 520px;
        background: linear-gradient(180deg, rgba(22, 163, 74, 0.07), transparent 45%), var(--card);
    ...
    <main class="card" role="main" aria-labelledby="title">
      <div class="icon-wrap" aria-hidden="true">
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" stroke="#16a34a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M22 4 12 14.01l-3-3" stroke="#16a34a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </div>
      <div class="badge">SUCCESS</div>
      <h1 id="title" class="title">Transaction Successful</h1>
      ...
      <div class="actions">
        <a class="button primary" href="transaction.jsp">Go to Home</a>
        <a class="button secondary" href="TransactionHistory.jsp">View Transactions</a>
      </div>
